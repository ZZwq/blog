  ...
  <div class="infosbox">
    ...
    <div class="share">
      ...
      <div class="shang_box"> <a class="shang_close" href="javascript:void(0)" onclick="dashangToggle()" title="关闭">关闭</a>
        ...
        <div class="shang_payimg"> <img src="/uploads/images/_20190528211207.png" alt="扫码支持" title="扫一扫"> </div>
        <div class="pay_explain">扫码打赏，你说多少就多少</div>
        <div class="shang_payselect">
          <div class="pay_item checked" data-id="alipay"> <span class="radiobox"></span> <span class="pay_logo"><img src="/uploads/images/_20190528211207.png" data-id="weipay"> <span class="radiobox"></span> <span class="pay_logo"><img src="/uploads/images/_20190528205209.png" alt="微信"></span> </div>
        </div>
    ...
    <div class="otherlink">
      ...
      <ul>
        ...
        <li><a href="/" title="{{ $v->desc }}">{{ $v->title }}</a></li>
        @endforeach
      </ul>
    </div>
  <div class="news_pl">
    ...
    <div class="comment-entry f-12 first">
     ...
     <div class="comment-item">  
        <div class="details f-aid">
          <span>头像:<img style="width:100px;" src="/uploads/{{$data->thumb}}"></span>
          <br> 
...
<footer>
  <p>Design by <a href="http://swarp.wang" target="_blank">个人博客</a> <a href="/">京ICP备11002373号-1</a></p>
</footer>
